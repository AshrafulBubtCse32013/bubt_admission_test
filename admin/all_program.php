                    ...
                    <div class="card">
                        <div class="card-content collapse show">
                            <div class="table-responsive">
                                ...
                                <table class="table" id="datatable-default">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="edit_program.php?id=<?= $row["cat_id"]; ?>"
                                                    class="btn btn-success">Edit</a>
                                                <a href="./operation/programdelect.php?id=<?= $row["cat_id"]; ?>"
                                                    class="btn btn-danger">Delete</a>
                                                <a href="./questions.php?program_id=<?= $row["cat_id"] ?>"
                                                    class="btn btn-info"><i class="fa fa-print" aria-hidden="true"></i>
                                                    Question</a>
                                            </td>
                                        </tr>
                                        <?php endwhile; ?>
                                ...
                                <?php else : ?>
                                <h2 class="alert alert-danger text-center">NO Progam</h2>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
