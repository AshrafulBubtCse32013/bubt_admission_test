                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info mb-2" role="alert">
                                            ...
                                            <a href="#" class="alert-link">your attention</a>, but it's not super
                                            important.
                                        </div>
                                        <h6>Light Alert</h6>
                                        <div class="alert alert-light mb-2" role="alert">
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                ...
                                                <div class="alert alert-primary alert-dismissible mb-2" role="alert">
                                                    ...
                                                    <p>Aww yeah, you successfully read this
                                                        <a href="#" class="alert-link">important alert</a> message. This
                                                ...
                                                <div class="alert alert-success border-0 alert-dismissible mb-2"
                                                    role="alert">
                                                    <button type="button" class="close" data-dismiss="alert"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <p>Aww yeah, you successfully read this important alert message.
                                                        ...
                                                        <a href="#" class="alert-link">spacing within</a> an alert works
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                ...
                                                <div class="alert alert-warning alert-dismissible mb-2" role="alert">
                                                    ...
                                                    <p>Aww yeah, you successfully read this important alert message.
                                                        ...
                                                        <a href="#" class="alert-link">going to run</a> a bit longer so
                                                        that you can see how spacing within an alert works with this
                                                        kind of content.</p>
                                                    <p class="mb-0">Whenever you need to, be sure to use margin
                                                        utilities to keep things nice and tidy.</p>
                                                ...
                                                <div class="alert alert-info border-0 alert-dismissible mb-2"
                                                    role="alert">
                                                    <button type="button" class="close" data-dismiss="alert"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    ...
                                                    <p>Aww yeah, you successfully read this important alert message.
                                                        ...
                                                        <a href="#" class="alert-link">an alert</a> works with this kind
                                                        of content.</p>
                                                    <p class="mb-0">Whenever you need to, be sure to use margin
                                                        utilities to keep things nice and tidy.</p>
                                                </div>
                                                ...
                                                <div class="alert alert-amber alert-dismissible mb-2" role="alert">
                                                    ...
                                                    <p>Aww yeah, you successfully read this important alert message.
                                                        ...
                                                        kind of content.</p>
                                                    <p class="mb-0">Whenever you need to, be sure to use margin
                                                        <a href="#" class="alert-link">utilities</a> to keep things nice
                                                        and tidy.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <p>Add a dismiss button and the
                                            <code>.alert-dismissible</code> class, which adds extra padding to the right
                                            of the alert and positions the
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        ...
                                        <h6>Primary Alert</h6>
                                        <div class="alert round bg-primary alert-icon-left alert-dismissible mb-2"
                                            role="alert">
                                        ...
                                        <h6>Warning Alert</h6>
                                        <div class="alert round bg-warning alert-icon-right alert-dismissible mb-2"
                                            role="alert">
                                            <span class="alert-icon">
                                                <i class="ft-watch"></i>
                                            </span>
                                        ...
                                        <h6>Info Alert</h6>
                                        <div class="alert round bg-info alert-icon-right alert-dismissible mb-2"
                                            role="alert">
                                            <span class="alert-icon">
                                                <i class="ft-video"></i>
                                            </span>
                                        ...
                                        <h6>light Alert</h6>
                                        <div class="alert round alert-light alert-icon-right alert-dismissible mb-2"
                                            role="alert">
                                            <span class="alert-icon">
                                        ...
                                        <h6>Custom Alert</h6>
                                        <div class="alert round bg-cyan alert-icon-right alert-dismissible mb-2"
                                            role="alert">
                                            <span class="alert-icon">
                                                <i class="ft-link-2"></i>
                                            </span>
